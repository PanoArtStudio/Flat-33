...
// Generated Ср апр 16 13:47:20 2025
...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		this._hide_elements.appendChild(this._fullscreen_off);
		...
		this._hide_elements.appendChild(this._movemode_1);
		...
		this._hide_elements.appendChild(this._movemode_2);
		...
		this._ut4.ggUpdateText=function() {
		...
		this._markertemplate.appendChild(this._ut4);
		...
		this._marker_node5.ggLeft=15;
		this._marker_node5.ggTop=-100;
		...
		this._ut3__text.innerHTML="Balcony";
		...
		this._marker_node5.appendChild(this._ut3);
		...
		this._ut2__text.innerHTML="Guestroom";
		...
		this._ut2.ggUpdatePosition=function (useTransition) {
			...
			this.style[domTransition]='none';
			this.ggTextDiv.style.left=((81-this.ggTextDiv.offsetWidth)/2) + 'px';
		}
		this._marker_node6.appendChild(this._ut2);
		...
		this._marker_node3.ggLeft=85;
		this._marker_node3.ggTop=-22;
		...
		this._ut1__text.innerHTML="Kitchen";
		...
		this._marker_node3.appendChild(this._ut1);
		...
		this._marker_node4.ggLeft=85;
		this._marker_node4.ggTop=91;
		...
		this._ut0.ggUpdatePosition=function (useTransition) {
			...
			this.style[domTransition]='none';
			this.ggTextDiv.style.left=((63-this.ggTextDiv.offsetWidth)/2) + 'px';
		}
		this._marker_node4.appendChild(this._ut0);
		...
		this._marker_node2.ggLeft=15;
		this._marker_node2.ggTop=91;
		...
		this._ut__text.innerHTML="ENTER 33";
		...
		this._marker_node2.appendChild(this._ut);
		...
		this._button_1.ggLeft=-135;
		this._button_1.ggTop=-85;
		...
		this._button_1.onclick=function (e) {
			me.player.openUrl("https:\/\/www.panoartstudio.com","");
		}
